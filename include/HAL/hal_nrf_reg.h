...
//typedef struct {
//   unsigned char p0[5];            /**< Pipe0 address, 5 bytes */
//    unsigned char p1[5];            /**< Pipe1 address, 5 bytes, 4 MSB bytes shared for pipe1 to pipe5 */
//    unsigned char p2[1];            /**< Pipe2 address, 1 byte */
//    unsigned char p3[1];            /**< Pipe3 address, 1 byte */
//   unsigned char p4[1];            /**< Pipe3 address, 1 byte */
//   unsigned char p5[1];            /**< Pipe3 address, 1 byte */
//   unsigned char tx[5];            /**< TX address, 5 byte */
